...
<body class="form-bg">
    ...
    <style>
        ...
        .course-block .box {
            ...
            background-image: url('{{ asset('user/images/abstract-2.svg') }}');
        ...
        <div class="signUp-block">
            <div class="row">
                <div class="col-lg-4 mx-auto">
                    <div class="signUp-form-block1" id="auth-block">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <div class="signUp-form-block1 course-block p-10" id="course-block">
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            @foreach ($course as $courseId => $item)
                                <div class="col-lg-4">
                                    <div class="box bg-img ribbon-box subject-side-badge pointer"
                                        ...
                                        <div class="card-body pb-2 mr-55">
                                            <div class="h-60">
