...
<body class="form-bg">
    ...
    <style>
        ...
        .form-bg {
            background: url('{{ asset('user/images/login-body-bg.jpg') }}');
        ...
        <div class="signUp-block">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="course-block p-10 " id="course-block">
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="row">
                                    <div class="col-lg-12 bg-white  shadow-lg ">
                                        <div class="row">
                                            <div class="col-lg-12 text-center">
                                                <div class="content-top-agile mb-20 mt-15">
                                                    <img src="{{ asset('user/images/logo-dark-text.png') }}"
                                                        alt="logo">
                                                    <p class="mb-0">Choose atleast one Course to Continue.
                                                    </p>
                                                </div>
                                            </div>
                                            @foreach ($course as $courseId => $item)
                                                <div class="col-lg-4">
                                                    <div class="box bg-img ribbon-box subject-side-badge pointer"
                                                        data-id="{{ $courseId }}"
                                                        style="background-image: url('{{ asset('user/images/abstract-2.svg') }}');background-position: right top; background-size: 30% auto;">
