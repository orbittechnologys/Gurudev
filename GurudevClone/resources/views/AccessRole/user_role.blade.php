    ...
    <div class="row mt-30">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="control-label">Admin Users</label>

                                    {{Form::select("staff_id",$admins,$id,["class"=>"form-control  select2-show-search search_dropdown w-100 ","id"=>"admins",'placeholder'=>'Users'])}}
        ...
        <div class="col-lg-9">
            <div class="card">
                ...
                {{ Form::model($model,array('url'=>'/accessRole/userRole', 'method' => 'post','enctype'=>"multipart/form-data",'id'=>'accessRoleForm'))}}
                ...
                {{ Form::hidden('rowIds',$rowIds) }}
                    ...
                    <div class="card-body p-6">
                        <h3 class="text-center pt-20">Please Select Staff to Assign Role</h3>
                    </div>
                    @endif
                {{Form::close()}}
...
<script>
    $('#admins').on('change',function () {
        ...
        if($(this).val()>0 && staff_id!==$(this).val())
          window.location='{{url('accessRole/userRole')}}/'+$(this).val()
    })
