<header class="main-header">
    <div class="d-flex align-items-center logo-box justify-content-start">
        ...
        <a href="#" class="logo">
            <!-- logo-->
            <div class="logo-lg">
                <span class="light-logo"><img src="{{asset('/user/images/logo-dark-text.png')}}" class="logo-img" alt="logo"></span>
                <span class="dark-logo"><img src="{{asset('/user/images/logo-dark-text.png')}}" class="logo-img" alt="logo"></span>
            </div>
        </a>
    </div>
    <!-- Header Navbar -->
            ...
            <div id="wf_qb">
                <div class="wf_qb">
                    <div id="wf_qb_infohead" class="wf-header-1">
                        <h4 class="wf_bright" style="display: inline-block">{{ $questions['quiz_name'] }}</h4>
                        <br>
                        <b><i class="fa fa-arrow-circle-left cursor-pointer"></i> Question
                            <span class="question_counter">1</span> of <span
                                    id="total_question_count">{{ $questions['total_questions'] }}</span></b> <i
