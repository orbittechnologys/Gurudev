<style>
    .header-desktop {
        background: url('{{asset('user/images/logo-dark-text.png')}}');
        display: block;
        position: absolute;
        width: 250px;
        height: 40px;
        ...
        <div class="container-fluid">
            <div class="d-flex header-nav">
                ...
                <div class="color-headerlogo">
                    <a class="header-desktop" href="{{url('/admin/dashboard')}}"></a>
                    <a class="header-mobile" href="{{url('/admin/dashboard')}}"></a>
                </div><!-- Color LOGO -->
                ...
                <div class="d-flex order-lg-2 ml-auto header-right-icons header-search-icon">
                    ...
                    <div class="dropdown header-user">
                        <a href="#" class="nav-link icon" data-toggle="dropdown" style="display: inline-flex;">
                            <h5 class="hidden-hedder-mobile mr-20">{{ Auth::guard('admin')->user()->name}} </h5>
                            <span><img src="{{ uploads('Uploads/default.png')}}" alt="profile-user" class="avatar brround cover-image mb-0 ml-0"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            <div class=" dropdown-header noti-title text-center border-bottom p-3">
                                <div class="header-usertext">
                                    ...
                                    <p class="mb-0">{{ Session::get('department')}}</p>
                                    <p class="mb-0">{{ Session::get('designation')}}</p>
                                </div>
                            </div>
