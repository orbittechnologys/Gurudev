...
@section('content')
    ...
    <div class="row mt-15">
        <div class="col-md-12">
            {{ Form::open(['url' => 'admin/specialTest/save', 'method' => 'POST', 'class' => 'validate-form', 'id' => 'questionAddForm']) }}
                                        ...
                                        @if ($quiz_type != 2)
                                            <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    @if ($quiz_type == 0)
                                                        <label class="fs-17">Title : {{ $chapterDetails->chapter }}
                                                        </label>
                                        ...
                                        @if ($quiz_type == 2)
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    {{ Form::text('total_time', null, ['class' => 'total_time form-control search_dropdown', 'placeholder' => 'Total Time', 'required', 'readonly']) }}
                                                </div>
                                            </div>
                                        @else
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group mb-3">
                                                    {{ Form::select('total_time', $times, null, ['class' => 'form-control select2-show-search search_dropdown', 'placeholder' => 'Total Time', 'required', 'readonly']) }}
                                                </div>
                                            </div>
                                        @endif
                                        <div class="col-lg-4">
                                            <div class="form-group mb-3">
                                                ...
                                                {{ Form::select('status', ['Active' => 'Active', 'InActive' => 'In-Active'], null, ['class' => 'form-control select2']) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-10">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group mb-3">
                                        ...
                                        {{ Form::text('category', null, ['class' => 'form-control category-field', 'placeholder' => 'Ex: Mathematics,General Ability Test,General Knowledge', 'autocomplete' => 'off']) }}
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group mb-3">
                                        ...
                                        {{ Form::select('cat_time', $times, null, ['class' => 'form-control category-time ', 'placeholder' => 'Time', 'autocomplete' => 'off']) }}
...
@push('includeJs')
    ...
    <script>
        ...
        function searchQuestion(page = '') {
            ...
            $('#pagination1').html('')
            $('#questionPoll').load('{{ url('/admin/questions/dragDrop') }}' + '/' + encodeURIComponent(search_string) +
