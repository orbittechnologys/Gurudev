                ...
                <div class="card " id="marks-detail">
                    <div class="card-header">
                        <div class="card-title ">
                            <h5>
                                {{ $key_answers['quiz']['special_course']['course'] }} :
                                @if ($key_answers['quiz']['st_sub_course']['title'] != '')
                                    {{ $key_answers['quiz']['st_sub_course']['title'] }} :
                                @endif
                                @if ($key_answers['quiz']['quiz_name'] != '')
                                    {{ $key_answers['quiz']['quiz_name'] }}
                                @endif
                            </h5>
                        </div>
                        <div class="card-controls pull-right">
                            ...
                            <div class="col">
                                <div class="text-center">
                                    <span class="font-large-1">{{ $key_answers['total_time_taken'] }} </span>
                                    <p class="font-weight-600">Minutes</p>
                                </div>
                            </div>
                            <div class="col">
                                <div class="text-center">
                                    <span class="font-large-1">{{ $key_answers['quiz']['total_time'] . ':00' }} </span>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="text-center text-gray">
                                            <span class="font-large-1">{{ $answeredCount }}</span>
                                            <p class="font-weight-600">Answered </p>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="text-center text-success">
                                            <span class="font-large-1 ">{{ $answeredCount - $wrongAnsCount }}</span>
                                            <p class="font-weight-600">Correct </p>
                                        </div>
                                    </div>
                                    <div class="col" style="border-right: 2px solid #c0c2c3;">
                                        <div class="text-center text-danger">
                                            <span class="font-large-1 ">{{ $wrongAnsCount }}</span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="text-center text-gray">
                                            <span class="font-large-1">{{ $unAttended }}</span>
                                    ...
                                    <div class="col">
                                        <div class="text-center text-gray">
                                            <span
                                                class="font-large-1 ">{{ sizeof($key_answers['user_quiz_question_detail']) - $answeredCount }}</span>
                            ...
                            <div class="col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="text-center text-success">
                                            <span
                                                class="font-large-1">{{ abs($key_answers['obtained_marks'] + $key_answers['negative_marks']) }}</span>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            @foreach ($subjectArrayCount as $subject => $subjectCount)
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item flexbox pb-0 pt-0" href="#">
                                            ...
                                            <span class="badge badge-pill badge-lg answered_count">
                                                {{ str_pad($subjectCount['Answered'], 2, 0, STR_PAD_LEFT) }}
                                            </span>
                                        </a>
                                        ...
                                        <a class="dropdown-item flexbox pb-0 pt-0" href="#">
                                            ...
                                            <span class="badge badge-pill badge-lg not_answered_count">
                                                {{ str_pad($subjectCount['not-answered'], 2, 0, STR_PAD_LEFT) }}
                                            </span>
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item flexbox pb-0 pt-0" href="#">
                                            ...
                                            <span class="badge badge-pill badge-lg not_visited_count">
                                                {{ str_pad($subjectCount['not-visited'], 2, 0, STR_PAD_LEFT) }}
                                            </span>
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item flexbox pb-0 pt-0" href="#">
                                            ...
                                            <span class="badge marked_review_count badge-lg badge-pill">
                                                {{ str_pad($subjectCount['review'], 2, 0, STR_PAD_LEFT) }}
                                            </span>
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item flexbox pb-0 pt-0" href="#">
                                            ...
                                            <span class="badge badge-pill badge-lg answered_mark_review_count">
                                                {{ str_pad($subjectCount['answered-and-mark'], 2, 0, STR_PAD_LEFT) }}
                                            </span>
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item flexbox pb-0 pt-0" href="#">
                                            ...
                                            <span class="badge badge-pill badge-lg badge-warning">
                                                {{ str_pad($subjectCount['total'], 2, 0, STR_PAD_LEFT) }}
                                            </span>
                                        </a>
                                    </div>
                                </div>
...
@push('includeJs')
    <script>
        // $('.wrongAnsCount').html('{{ $wrongAnsCount }}')
