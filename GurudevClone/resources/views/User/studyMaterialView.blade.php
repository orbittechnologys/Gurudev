...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/web-pdf-viewer/css/pdfjs-viewer.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/web-pdf-viewer/css/pdftoolbar.css') }}">
    {{-- <script src="{{ asset('assets/web-pdf-viewer/js/pdf.min.js') }}"></script> --}}
    <script src="{{ asset('assets/web-pdf-viewer/js/pdfjs-viewer.js') }}"></script>
    <script>
...
<body>
    <div class="pdfviewer">
        <div class="pdftoolbar">
            <button class="pushed" onclick="togglethumbs(this);"><i
                    class="material-icons-outlined">view_sidebar</i></button>
            <div class="v-sep"></div>
            ...
            <input id="pageno" class="pageno" type="number" class="form-control form-control-sm d-inline w-auto"
                value="1" min="1" max="1000" onchange="pdfViewer.scrollToPage(parseInt(this.value))">
            ...
            <div class="divider"></div>
            <div>
                <a href="{{url($backurl)}}" class=" btn first btn-primary back-btn">Back</a>
            </div>
        ...
        <div class="pdfviewer-container">
            ...
            <div class="maindoc pdfjs-viewer">
                <div class="pdfpage placeholder">
                    <p class="my-auto mx-auto">File Not Found</p>
                </div>
            </div>
        </div>
    </div>
