            ...
            <div class="row p-1 ">
                <div class="col-12">
                    <div class="my-card-1 mb-1">
                        ...
                        @foreach ($subject as $subKey => $sub)
                            @if ($subject_tot_count[$sub] > 0)
                                <li class="nav-item">

                                    <a class="nav-link current_step btn_my" data-time="{{ $subjectTime[$sub] }}"
                                        data-subject="{{ $sub }}" data-tab-start="{{ $final_counter[$i] }}"
                                        data-index="{{ $i }}"
                                        data-category-spend-time="{{ $category_info[$sub] }}" data-toggle="tab"
                                        href="javascript:void(0)" aria-selected="true">{{ $sub }} </a>

                                    <div class="my-hover-card text-left">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="answered_count" data-subject="{{ $sub }}"
                                                    data-time="{{ $sub }}">
                                                    {{ 0 + $subject_qu_counter[$sub]['answered'] }}</div> Answered
                                            </div>
                                            <div class="col-12">
                                                <div class="not_answered_count" data-subject="{{ $sub }}">
                                                    {{ 0 + $subject_qu_counter[$sub]['not_answered'] }}</div> Not Answered
                                            </div>
                                            <div class="col-12">
                                                <div class="not_visited_count" data-subject="{{ $sub }}">
                                                    {{ 0 + $subject_qu_counter[$sub]['not_visited'] }}</div> Not Visited
                                            </div>
                                            <div class="col-12">
                                                <div class="marked_review_count" data-subject="{{ $sub }}">
                                                    {{ 0 + $subject_qu_counter[$sub]['marked_review'] }}</div> Marked For
                                                Review
                                            </div>
                                            <div class="col-12">
                                                <div class="answered_mark_review_count" data-subject="{{ $sub }}">
                                                    {{ 0 + $subject_qu_counter[$sub]['answered_marked_review'] }}</div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body px-1 py-0">
                                            ...
                                            <input type="hidden" id="mock_test_id" value="{{ $mock_details['id'] }}">
                                            <input type="hidden" id="course_id" value="{{ $mock_details['course_id'] }}">
                                            <input type="hidden" id="spend_time"
                                                data-mock-update-url="{{ url('specialTest/updateResult') }}"
                                                data-mock-spend-time="00:00:00"
                                                data-question-allocation-id="{{ $mock_details['id'] }}"
                                                data-user-mock-detail-id="{{ $mock_details['user_quiz_detail']['id'] }}"
                                                data-key-answer-url="{{ url('user/mock_test/list/2') }}">
                                                    ...
                                                    <div class='step-by-step' id='setup'>
                                                        ...
                                                        @foreach ($questions as $question)
                                                            <div class='step-by-step-step split-h mr-10 ml-10'>
                                                                <div class="data_set"
                                                                    data-user-mock-question-detail-id="{{ $question['umqd_id'] }}"
                                                                    data-user-mock-detail-id="{{ $mock_details['user_quiz_detail']['id'] }}"
                                                                    data-subject-id="{{ $question['category'] }}"
                                                                    data-question-id="{{ $question['question_id'] }}"
                                                                    data-given-answer="{{ $question['given_answer'] }}"
                                                                    data-mark-review="{{ $question['mark_review'] }}"
                                                                    data-marks="{{ $question['question']['marks'] }}"
                                                                    data-correct-answer="{{ $question['question']['correct_answer'] }}"
                                                                    data-negetive-marks="{{ $question['question']['negative_marking'] }}"
                                                                                                ...
                                                                                                <div class="row ">
                                                                                                    ...
                                                                                                    @if ($question['question']['answer1'] != '')
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div class="wf_qb1_answer_row wf_qb1_answer_row_open  @if ('answer1' == $question['given_answer']) wf_qb1_answer_row_done @endif"
                                                                                                                onclick="answer_selected(this,'answer1','{{ $question['question']['id'] }}','{{ $question['category'] }}')">
                                                                                                                <div
                                                                                                    ...
                                                                                                    @if ($question['question']['answer2'] != '')
                                                                                                        <div
                                                                                                            class="col-md-12 px-1">
                                                                                                            <div class="wf_qb1_answer_row wf_qb1_answer_row_open  @if ('answer2' == $question['given_answer']) wf_qb1_answer_row_done @endif"
                                                                                                                onclick="answer_selected(this,'answer2','{{ $question['question']['id'] }}','{{ $question['category'] }}')">
                                                                                                                <div
                                                                                                                    class="wf_qb1_answer_row_inner">
                                                                                                                    <input
                                                                                                                        type="radio"
                                                                                                    ...
                                                                                                    @if ($question['question']['answer3'] != '')
                                                                                                        <div
                                                                                                            class="col-md-12 px-1">
                                                                                                            <div class="wf_qb1_answer_row wf_qb1_answer_row_open @if ('answer3' == $question['given_answer']) wf_qb1_answer_row_done @endif"
                                                                                                                onclick="answer_selected(this,'answer3','{{ $question['question']['id'] }}','{{ $question['category'] }}')">
                                                                                                                <div
                                                                                                                    class="wf_qb1_answer_row_inner">
                                                                                                                    <input
                                                                                                                        type="radio"
                                                                                                    ...
                                                                                                    @if ($question['question']['answer4'] != '')
                                                                                                        <div
                                                                                                            class="col-md-12 px-1">
                                                                                                            <div class="wf_qb1_answer_row wf_qb1_answer_row_open @if ('answer4' == $question['given_answer']) wf_qb1_answer_row_done @endif"
                                                                                                                onclick="answer_selected(this,'answer4','{{ $question['question']['id'] }}','{{ $question['category'] }}')">
                                                                                                                <div
                                                                                                                    class="wf_qb1_answer_row_inner">
                                                                                                                    <input
                                                                                                                        type="radio"
                                                                                                    ...
                                                                                                    @if ($question['question']['answer5'] != '')
                                                                                                        <div
                                                                                                            class="col-md-12 px-1">
                                                                                                            <div class="wf_qb1_answer_row wf_qb1_answer_row_open @if ('answer5' == $question['given_answer']) wf_qb1_answer_row_done @endif"
                                                                                                                onclick="answer_selected(this,'answer5','{{ $question['question']['id'] }}','{{ $question['category'] }}')">
                                                                                                                <div
                                                                                                                    class="wf_qb1_answer_row_inner">
                                                                                                                    <input
                                                                                                                        type="radio"
                                                                                                    ...
                                                                                                    @if ($question['question']['answer6'] != '')
                                                                                                        <div
                                                                                                            class="col-md-12 px-1">
                                                                                                            <div class="wf_qb1_answer_row wf_qb1_answer_row_open @if ('answer6' == $question['given_answer']) wf_qb1_answer_row_done @endif"
                                                                                                                onclick="answer_selected(this,'answer6','{{ $question['question']['id'] }}','{{ $question['category'] }}')">
                                                                                                                <div
                                                                                                                    class="wf_qb1_answer_row_inner">
                                                                                                                    <input
                                                                                                                        type="radio"
                                                            ...
                                                            @if (
                                                                ...
                                                                <div class="hidden-resume-click current_step hidden"
                                                                    data-subject="{{ $question['category'] }}"
                                                                    data-tab-start="{{ $j + 1 }}">
                                                                    {{ $j + 1 }}</div>
                                                                @php($resume = 1)
                                                            @endif
                ...
                <div class="col-md-3">
                    ...
                    <div class="question_counter_card p-1 mb-1" align="center">
                        ...
                        @for ($i = 0; $i < count($questions); $i++)
                            <div class="question_counter_div current_step {{ $questions[$i]['question_status'] }} "
                                data-tab-start="{{ $i + 1 }}">{{ $i + 1 }}</div>
                        @endfor
                    </div>
                    ...
                    <div class="chart-info d-flex justify-content-between mt-20">
                        <div class="text-center ">
                            <p class="mb-50 ">Total Time :<span
                                    class="font-weight-bold">{{ $mock_details['total_time'] . ':00' }}</span></p>
                        </div>
...
@push('includeJs')
    ...
    {{ Html::script('user/quiz/stepzation-master/mock_stepzation.js') }}
    ...
    <script async>
        ...
        if (window.opener) {
            ...
            window.location="{{ url('user/mock_test/list') }}/"+'{{ $mock_details['course_id'] }}'
        } else {
            window.location="{{ url('user/mock_test/list') }}/"+'{{ $mock_details['course_id'] }}'
        }
        ...
        @if ($mock_details['user_quiz_detail'])
            total_time_taken = '{{ $mock_details['user_quiz_detail']['total_time_taken'] }}';
        @endif
        $('.wf_bright').html('{{ $mock_details['quiz_name'] }}')
        $('#total_question_count').html('{{ $mock_details['total_questions'] }}')

        var total_time = '{{ $mock_details['total_time'] }}:00';
