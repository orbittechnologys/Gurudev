        ...
        <div class="d-flex align-items-center">
            ...
            <div class="float-right mr-10">
                <div class="input-group input-search">
                    ...
                    <a href="{{url('mcq')}}" class="btn btn-dropbox btn-sm ml-20">MCQ's</a>
                ...
                @foreach($current_affairs as $key=>$list)
                    <div class="col-md-12 col-lg-4">
                        <div class="card cursor-pointer">
                                    ...
                                    <ul class="list-inline mb-0 bookmark-container">
                                        <li class="list-inline-item">
                                            <a href="javascript:void(0)" class="bookmarked" data-id="{{$list->id}}" data-type="CurrentAffairs">
                                                <i class="fa {{$list->bookmark->id > 0 ? 'fa-bookmark' : 'fa-bookmark-o' }}"></i>
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <div class="card-body">
                                <h5 class="card-title {{$list->is_kannada}}"> {{ \Illuminate\Support\Str::limit($list->title, 30, $end='...') }}</h5>
                                <p class="card-text current-affair-description {{$list->is_kannada}}"> {!! \Illuminate\Support\Str::limit(strip_tags($list->description), 80, $end='...') !!}</p>
                                    <a href="{{ url('currentAffairs?searchString='.$list->slug)}}" class="text-danger anchor">Read More</a></p>
                            </div>
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card ">
                        ...
                        <div class="card-body text-center">
                            ...
                            <h3 class="font-large-2 my-1"> No Current Affairs Found!</h3>
...
@push('includeJs')
    <script>
        ...
        /*$('.socialMediaShare').on('click',function(e){
            e.stopPropagation()
           //return false;
        });*/
