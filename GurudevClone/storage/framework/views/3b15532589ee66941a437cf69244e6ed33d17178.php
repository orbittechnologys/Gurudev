...
<?php $__env->startSection('title', ($quiz->count() > 0 ? $quiz[0]->specialCourse->course :$specialTestSubCourse[0]->course->course)); ?>
<?php $__env->startSection('content'); ?>
                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<?php echo e(url('/specialTest/course')); ?>">Test Series Course</a>
                            </li>
                            <?php if($quiz->count() > 0): ?>
                                <li class="breadcrumb-item" aria-current="page">
                                    <?php echo e($quiz[0]->specialCourse->course); ?>

                                </li>
                                <?php if(isset($quiz[0]->stSubCourse)): ?>
                                    <li class="breadcrumb-item" aria-current="page">
                                        <?php echo e($quiz[0]->stSubCourse->title); ?>

                                    </li>
                                <?php endif; ?>
                            <?php else: ?>
                                <li class="breadcrumb-item" aria-current="page">
                                    <?php echo e($specialTestSubCourse[0]->course->course); ?>
    ...
    <section class="content">
        <div class="row mcq-details">
            ...
            <?php ($k = 1); ?>
            <?php $__currentLoopData = $specialTestSubCourse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if ($k == 4) {
                    $k = 1;
                } ?>
                <div class="col-lg-4 col-md-4 col-12">
                    ...
                    ?>
                    <div class="box bg-img ribbon-box subject-side-badge pointer <?php echo e($class); ?>"
                        slug="<?php echo e($list->id); ?>" typeId="<?php echo e($list->id); ?>" amount="<?php echo e($list->amount); ?>"
                        courseName="<?php echo e($list->title); ?>" slug="<?php echo e($list->id); ?>"
                        ...
                        <div class="card-body pb-2">
                            <div class="h-90">
                                <a href="javascript:void(0)" style="color: #172b4c;"
                                    class="h-10 box-title font-weight-600 text-muted hover-primary font-size-18"><?php echo e($list->title); ?></a>
                                <div class="font-weight-bold mt-35 mb-10"><span class="text-danger font-size-18"> <i
                                            class="fa fa-rupee"></i><?php echo e($list->amount); ?>/-</span></div>
                            </div>
            ...
            <?php ($borderCount = 0); ?>
            <?php $__currentLoopData = $quiz; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($borderCount == 3): ?>
                    <?php ($borderCount = 0); ?>
                <?php endif; ?>

                <?php if($list->userQuizDetail == null || $list->userQuizDetail['status'] == 0): ?>
                    <div class="col-xl-4 col-12">
                        <div class="box bl-2 border-<?php echo e($border[++$borderCount]); ?> rounded pull-up QuizWait quiz-box"
                            type="Special Test" url="<?php echo e(url('/specialTest/onlineTest/' . $list->id)); ?>"
                            title="<?php echo e($list->quiz_name); ?>" totQuestion="<?php echo e($list->total_questions); ?>"
                            instruction="<?php echo e($instruction); ?>"
                            start_date_time="<?php echo e(date('d-m-Y h:i A', strtotime($list->start_date_time))); ?>"
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center pr-2 justify-content-between">
                                        <h4 class="font-weight-500">
                                            <?php echo e($list->quiz_name); ?>

                                        </h4>
                                    </div>
                                    <p class="font-size-16">
                                        <span> <i class="fa fa-question-circle-o"></i> <?php echo e($list->total_questions); ?>

                                            Questions</span>
                                        <span class="float-right"> <i class="fa fa-clock-o-circle-o"></i>
                                            <?php echo e(time_to_decimal($list->total_time)); ?> Minutes</span>
                                    </p>
                                    <div class="timer" data-start='<?php echo e($list->start_date_time); ?>'></div>
                                </div>
                ...
                <?php //dd($list->userQuizDetail) ?>
                    <div class="col-xl-4 col-12">
                        <div class="box bl-2 border-<?php echo e($border[++$borderCount]); ?> rounded pull-up">
                            <div class="box-body">
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center pr-2 justify-content-between">
                                        <h4 class="font-weight-500">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-10">
                                    <div class="d-flex">
                                        <a href="<?php echo e(url('specialTest/keyAnswer/' . $list->userQuizDetail->id)); ?>"
...
<?php $__env->startPush('includeJs'); ?>
    ...
    <script>
        $('.purchased').on('click', function() {
            window.location = '<?php echo e(url('specialTest/quizList?id=')); ?>' + $(this).attr('slug') + '&courseType=4';
        })
    </script>
...
<?php echo $__env->make('layout.userMain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\91701\Downloads\gurudev\GurudevClone\resources\views/User/specialTestQuizList.blade.php ENDPATH**/ ?>