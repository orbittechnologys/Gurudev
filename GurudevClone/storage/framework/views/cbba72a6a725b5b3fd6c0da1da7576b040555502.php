<?php $__env->startSection("title","Test Series Sub Course"); ?>
    ...
    <div class="row mt-30">
        <div class="col-md-4">
            <div class="card overflow-hidden">
                ...
                <div class="card-body">
                    <?php echo e(Form::model($model,array('url'=>'/admin/specialTest/subCourse', 'method' => 'post', 'files' => true))); ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <?php echo e(Form::select('special_test_course_id',$specialTestCourses,null,['class'=>'select2-show-search required','required',"placeholder"=>"Special Test Course "])); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('title',null,['class'=>'form-control required','placeholder'=>'Sub Course Name','required'])); ?>
                        ...
                        <table id="current_affairs" class="table table-striped table-bordered w-100">
                            ...
                            <?php $__currentLoopData = $table_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $array): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td> <?php echo e($array['course']['course']); ?></td>
                                    <td> <?php echo e($array['title']); ?></td>
                                    <td> <?php echo e($array['type']); ?>  </td>
                                    <td> <?php echo e($array['amount']); ?></td>
                                    <td class="text-nowrap">
                                        <a href="<?php echo e(route('specialTestSubCourse',['id'=>$array['id']])); ?>"
                                           class="table_icons" data-toggle="tooltip" data-original-title="Edit"><i
                                                    class="ti ti-pencil" aria-hidden="true"></i></a>
                                        <a href="<?php echo e(route('dynamicDelete',['modal'=>'SpecialTestSubCourse','id'=>$array['id']])); ?>"
...
<?php echo $__env->make('layout.adminMain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\91701\Downloads\gurudev\GurudevClone\resources\views/Setting/adminSpecialTestSubCourse.blade.php ENDPATH**/ ?>