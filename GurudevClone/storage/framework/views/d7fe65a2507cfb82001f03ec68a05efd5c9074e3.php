<?php $__env->startSection('title','Special Test List'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="page-header">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#"><i class="fe fe-home mr-1"></i><?php echo e($cardTitle); ?></a></li>
        ...
        <div class="ml-auto">
            <div class="input-group input-search">
                ...
                <?php echo e(Form::text('global_search',null,['style'=>'width: 350px;','class'=>' form-control global_search ','placeholder'=>'Enter Question Or Tags to filter'])); ?>
    ...
    <a class="fixed-bottom-right" href="<?php echo e(url($addUrl)); ?>">
...
<?php $__env->startPush('includeJs'); ?>
    <?php echo Html::style('assets/plugins/jquery.richtext/jquery.richtext.css'); ?>

    <?php echo e(Html::script("assets/plugins/jquery.richtext/jquery.richtext.js")); ?>

    <?php echo e(Html::script("assets/plugins/jquery.richtext/wysiwyag.js")); ?>
    ...
    <script>
        ...
        $('#questions_load').load('<?php echo e(url($current_route)); ?>?searchString=all');
        var url='<?php echo e(url($current_route)); ?>'
    ...
    <script>
        ...
        function quiz_attended(id) {
            window.location.href = '<?php echo e(url('/admin/quiz/attended/')); ?>/' + id;
        }
        ...
        $("#questions_load").on("click",".confirm-delete_quiz", function (e) {
            ...
            return swal({
                ...
                if (isConfirm) {
                    ...
                    url: '<?php echo e(url("admin/quiz/delete")); ?>',
                    dataType: 'json',
        ...
        function quiz_detail(id) {
            window.location.href = '<?php echo e(url('admin/quiz/view')); ?>/' + id;
        }

    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layout.adminMain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\91701\Downloads\gurudev\GurudevClone\resources\views/Quiz/adminQuizList.blade.php ENDPATH**/ ?>