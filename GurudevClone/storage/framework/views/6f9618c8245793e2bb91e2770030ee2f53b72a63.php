...
<head>
    ...
    <?php echo Html::style("user/css/custom.css"); ?>

  
    
    <?php echo $__env->yieldPushContent('page_styles'); ?>
    <style>
        html {
...
<?php if(!request()->is('course/onlineTest/*') && !request()->is('mcq/onlineTest/*')&& !request()->is('specialTest/onlineTest/*')): ?>)
...
<?php else: ?>
    <?php echo $__env->make('includes.user.onlineTeastHeader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
    ...
    <?php if($backUrl): ?>
    <a href="<?php echo e(url($backUrl)); ?>" class=" btn  btn-primary back-btn"><i class="fa fa-arrow-circle-left"></i> </a>
<?php endif; ?>
                ...
                <div class="modal-body">
                            ...
                            <div class="mt-4 flex items-center justify-between">
                                <form method="POST" action="<?php echo e(route('verification.send')); ?>">
                                    ...
                                    <a href="<?php echo e(url('/logout')); ?>" type="submit" class="btn btn-danger btn-sm  float-right mr-5">
...
<?php echo Html::script("user/assets/icons/feather-icons/feather.min.js"); ?>
...
<?php echo Html::script("user/assets/vendor_components/sweetalert/jquery.sweet-alert.custom.js"); ?>
  ...
  <?php if(!request()->is('youtubeVideos') && !request()->is('course/subject/chapter/*')): ?>
<?php echo Html::script("user/assets/vendor_plugins/VideoJS/video-player.js"); ?>
...
<?php echo Html::script("user/js/template.js"); ?>

<?php echo Html::script("user/js/custom.js"); ?>

<?php echo Html::style("user/assets/vendor_plugins/VideoJS/video-js.min.css"); ?>

<?php echo Html::script("user/assets/vendor_plugins/VideoJS/video.js"); ?>

<?php echo Html::script("user/assets/vendor_plugins/VideoJS/youtube.js"); ?>

<?php echo $__env->make('includes.CssJs.sweat-alerts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->yieldPushContent('includeJs'); ?>
    ...
    let emailVarified = '<?php echo e(Auth::user()->email_verified_at); ?>'
...
<?php /**PATH C:\Users\91701\Downloads\gurudev\GurudevClone\resources\views/layout/userMain.blade.php ENDPATH**/ ?>