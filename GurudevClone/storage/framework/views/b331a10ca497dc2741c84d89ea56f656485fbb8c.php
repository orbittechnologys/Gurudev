<?php if($message = Session::get('success')): ?>
    ...
    <div class='notify-alert alert alert-success col-xl-3 col-lg-3 col-md-3 col-12 animated fadeInDown' id='php-alert'>
        <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><i class='fa fa-check'></i> <?php echo e($message); ?></div>
...
<?php elseif($message = Session::get('danger') ): ?>
    ...
    <div class='notify-alert alert alert-danger col-xl-3 col-lg-3 col-md-3 col-12 animated fadeInDown' id='php-alert'>
        <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><i class='fa fa-check'></i> <?php echo e($message); ?></div>
 <?php elseif($message = Session::get('sweet-success')): ?>
        <script>
...
<?php /**PATH C:\Users\91701\Downloads\gurudev\GurudevClone\resources\views/includes/CssJs/flash-message.blade.php ENDPATH**/ ?>