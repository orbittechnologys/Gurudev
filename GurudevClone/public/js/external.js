    ...
    return (function (e) {
        ...
        function (e, t) {
            ...
            function s() {
                ...
                var r = null;
                return (
                    n[3] && (r = n[3].match(/\s*at\s*(.+?)\s*\((\S*)\s*:(\d*)\s*:(\d*)\)/)),
                        !r || r.length <= 4
                            ? (0 === n[2].indexOf("log@") ? (e.methodName = n[3].substr(0, n[3].indexOf("@"))) : (e.methodName = n[2].substr(0, n[2].indexOf("@"))), e)
                            : ((e.methodName = r[1]), (e.fileLocation = r[2]), (e.line = r[3]), (e.column = r[4]), e)
                );
            }
            function o() {
                var e = arguments[0],
            ...
            (a.setGlobalOptions = function (e) {
                ...
                (e.exports = a),
                (a.levels = { TRACE: "trace", DEBUG: "debug", INFO: "info", LOG: "log", WARN: "warn", ERROR: "error" });
        },
        function (e, t, n) {
            "use strict";
            var r,
        ...
        function (e, t) {
            e.exports = function (e) {
                var t,
                    ...
                    l = function (e) {
                        ...
                        if (t.postis && t.scope === n) {
                            var r = s[t.method];
                            if (r) for (var i = 0; i < r.length; i++) r[i].call(null, t.params);
                ...
                var u = {
                        ...
                        send: function (e) {
                            var t = e.method;
                            (c || "__ready__" === e.method) && r && "function" == typeof r.postMessage ? r.postMessage(JSON.stringify({ postis: !0, scope: n, method: t, params: e.params }), "*") : o.push(e);
                        },
                        ready: function (e) {
                            c
                                ? e()
        ...
        function (e, t, n) {
            ...
            function c(e) {
                ...
                if (
                    ((e = e.replace(/\s/g, "")),
                        ...
                        (r = n.exec(e)),
                    r && ((t.protocol = r[1].toLowerCase()), (e = e.substring(n.lastIndex))),
                        (n = new RegExp("^(//[^/?#]+)", "gi")),
                        (r = n.exec(e)),
                        r)
                ) {
            ...
            "number" == typeof g && (y.scope = "jitsi_meet_external_api_" + g),
                ((window.JitsiMeetJS || (window.JitsiMeetJS = {}), window.JitsiMeetJS.app || (window.JitsiMeetJS.app = {}), window.JitsiMeetJS.app).setExternalTransportBackend = (e) => _.setBackend(e));
            var b = n(4),
                w = n(0);
            function L(e, t) {
                if (null == e) return {};
            ...
            class k extends i.a {
                constructor(e, ...t) {
                    ...
                    const {
                        ...
                        switch (typeof e[0]) {
                            ...
                            case void 0: {
                                ...
                                return { roomName: t, width: n, height: r, parentNode: i, configOverwrite: s, interfaceConfigOverwrite: o, noSSL: a, jwt: c, onload: l };
                            }
                            case "object":
                                return e[0];
                            default:
                    ...
                    (this._parentNode = s),
                        (this._url = I(e, { configOverwrite: o, interfaceConfigOverwrite: a, jwt: l, noSSL: c, roomName: n, devices: h, userInfo: p })),
                        this._createIFrame(i, r, u),
                        (this._transport = new v({ backend: new m({ postisOptions: { scope: "jitsi_meet_external_api_" + C, window: this._frame.contentWindow } }) })),
                ...
                invite(e) {
                    return Array.isArray(e) && 0 !== e.length ? this._transport.sendRequest({ name: "invite", invitees: e }) : Promise.reject(new TypeError("Invalid Argument"));
                }
                isAudioMuted() {
